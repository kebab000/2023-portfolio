...
window.addEventListener("scroll", ()=>{
    ...
    if (scrollTop < 26500){
        document.querySelector("#section1 .text .d3").innerHTML = "세부적인 곳까지 파고드는 개발자가 되겠습니다."   
        document.querySelector("#section1 .text .d2").innerHTML = "신입의 열정과 도전정신을 깊숙히 새기며 배움에 있어 겸손함을 유지하며"   
        document.querySelector("#section1 .text .d1").innerHTML = "어떤 일이라도 노력하고 즐기면  그 결과는 빛을 바란다고 생각합니다."   
