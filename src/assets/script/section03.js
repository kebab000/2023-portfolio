ScrollTrigger.matchMedia({
  ...
  "(min-width: 481px)": function () {
    ...
    ani1.to(".sec3-section1 .box .mockup", {
      duration: 1.5,
      autoAlpha: 1,
      x: 0,
    });
    ...
    ani2.to(".sec3-section2 .box .mockup", {
      duration: 1.5,
      autoAlpha: 1,
      x: 0,
    });
    ...
    ani3.to(".sec3-section3 .box .mockup", {
      duration: 1.5,
      autoAlpha: 1,
      x: 0,
    });
    ...
    ani4.to(".sec3-section4 .box .mockup", {
      duration: 1.5,
      autoAlpha: 1,
      x: 0,
    });
    ...
    ani5.to(".sec3-section5 .box .mockup", {
      duration: 1.5,
      autoAlpha: 1,
      x: 0,
    });
    ...
    ani6.to(".sec3-section6 .box .mockup", {
      duration: 1.5,
      autoAlpha: 1,
      x: 0,
    });
